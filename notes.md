...
- if avoid to allow a hacker to get the array from an input seach for example: "search[]"
http://127.0.0.1:8000/?_token=ivD70urDbBFXRZ33APfrZpvLWa4SXR1Bis9SXegu&search[]=nemo#

- lets install telescope, it's a powerfull laravel tool for debugging in php.
...
## notes
- cookies identify my browser to the server
